...
class ManageForumReferences implements Themeable, Translatable {
    ...
    private class RefTree extends ReferenceChooserTree {
        private ReferenceChooserTreeDnDSource _dndSrc;
        public RefTree() {
            super(_browser, _sash, new ReferenceChooserTree.ChoiceListener() {
    ...
    private static final String T_SRCGROUP = "syndie.gui.manageforumchannels.srcgroup";
}
